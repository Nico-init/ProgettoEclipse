...
public class AggiungiPietanzaAlMenuPane extends BorderPane {
	...
	public AggiungiPietanzaAlMenuPane(IControllerOrdine controllerO, IControllerAccount controllerA, IControllerMenu controllerM, IControllerLog controllerL) {
		...
		Label ordineL = new Label("Aggiungi Pietanza al Menù");
	...
	private void handler(Button inserisci) {
		...
		try {
			controllerM.aggiungiPietanza(nome, dPrezzo, categoria);
