...
public class OrdinePaneClientRistoratore extends BorderPane {
	...
	public OrdinePaneClientRistoratore(IControllerOrdine controllerO, IControllerAccount controllerA, IControllerMenu controllerM, IControllerLog controllerL) {
        ...
        TableColumn<BevandaOrdinata, Integer> colQuantit‡Bevanda = new TableColumn<BevandaOrdinata, Integer>("Quantit‡");
        colQuantit‡Bevanda.setCellValueFactory(new PropertyValueFactory<>("quantita"));  
        tableBevande.getColumns().addAll(colNomeBevanda, colQuantit‡Bevanda);
